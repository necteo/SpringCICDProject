                ...
                <table class="table" v-for="rvo in store.reply">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right">
                        <a href="#" class="btn btn-xs btn-info" v-if="rvo.id == _LOGIN_.sessionId">수정</a>
                        <a href="#" class="btn btn-xs btn-success" v-if="rvo.id == store.sessionId">삭제</a>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
	        ...
	        <tbody>
	          <tr>
	            <td class="text-center">
	              ...
	              <button class="btn-success" style="width: 80px; height: 103px; float: left"
	               @click="store.foodReplyInsert(fno, msgRef)">댓글쓰기</button>
	            </td>
	          </tr>
	        </tbody>
	      </table>
    ...
    const app = createApp({
      setup() {
	    ...
	    const addScript = () => {
	      ...
	      script.src = 'http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=8cbbd5d669a90ce360aaa6cf764e5bfb&libraries=services'

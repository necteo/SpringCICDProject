        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" class="text-left">{{store.vo.subject}}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="4" class="text-right">
                <a :href="'update?no=' + store.vo.no" class="btn btn-xs btn-warning">수정</a>
                <a :href="'delete?no=' + store.vo.no" class="btn btn-xs btn-info">삭제</a>
                <a href="list" class="btn btn-xs btn-success">목록</a>
              </td>
            </tr>
          </tbody>
        </table>
